...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I'm an adult,Hi，I'm a landscape photographer,Hi，I'm an adult with Attention deficit hyperactivity disorder (ADHD),Welcome to my Blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Waymond', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱胡思乱想的风光摄影师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://XXXXXXX.com', // 网站地址
